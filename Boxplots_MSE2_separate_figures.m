% The MSE_boxplots of both two modeling forms all examples and cases based on
...
% subplot(4,2,1);
figure(1);
boxplot(XX,'notch','on','labels',{'IPO','MIPO','SIPO','proposed IIPO'},'whisker',1);xlabel('Algorithms'); ylabel('MSE(dB)');title('The first IIR identification form, Example I, Case 1');
...
% subplot(4,2,2);
figure(2);
boxplot(XX,'notch','on','labels',{'IPO','MIPO','SIPO','proposed IIPO'},'whisker',1);xlabel('Algorithms'); ylabel('MSE(dB)');title('The second IIR identification form, Example I, Case 1');
...
% subplot(4,2,3);
figure(3);
boxplot(XX,'notch','on','labels',{'IPO','MIPO','SIPO','proposed IIPO'},'whisker',1);xlabel('Algorithms'); ylabel('MSE(dB)');title('The first IIR identification form, Example I, Case 2');
...
% subplot(4,2,4);
figure(4);
boxplot(XX,'notch','on','labels',{'IPO','MIPO','SIPO','proposed IIPO'},'whisker',1);xlabel('Algorithms'); ylabel('MSE(dB)');title('The second IIR identification form, Example I, Case 2');
...
% subplot(4,2,5);
figure(5);
boxplot(XX,'notch','on','labels',{'IPO','MIPO','SIPO','proposed IIPO'},'whisker',1);xlabel('Algorithms'); ylabel('MSE(dB)');title('The first IIR identification form, Example II, Case 1');
...
% subplot(4,2,6);
figure(6);
boxplot(XX,'notch','on','labels',{'IPO','MIPO','SIPO','proposed IIPO'},'whisker',1);xlabel('Algorithms'); ylabel('MSE(dB)');title('The second IIR identification form, Example II, Case 1');
...
% subplot(4,2,7);
figure(7);
boxplot(XX,'notch','on','labels',{'IPO','MIPO','SIPO','proposed IIPO'},'whisker',1);xlabel('Algorithms'); ylabel('MSE(dB)');title('The first IIR identification form, Example II, Case 2');
...
% subplot(4,2,8);
figure(8);
boxplot(XX,'notch','on','labels',{'IPO','MIPO','SIPO','proposed IIPO'},'whisker',1);xlabel('Algorithms'); ylabel('MSE(dB)');title('The second IIR identification form, Example II, Case 2');
