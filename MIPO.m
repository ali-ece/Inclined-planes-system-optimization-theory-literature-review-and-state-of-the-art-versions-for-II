...
plots = 1;
numofruns  = 200 ;
numofdims  = 2  ;       % Exp. 1:2;  Exp. 2:4;  Exp. 3:9; Exp. 3.1=11;
numofballs = 50  ;

k1damp = .005 ;  % Exp. 1: 0.11  Exp. 3: 0.004
k2damp = 0.9   ;  % Exp. 1:  2    Exp. 3: 0.9
k1     = 0    ;%
k2     = 0    ;
